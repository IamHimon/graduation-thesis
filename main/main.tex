...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  % 英文封面内容
  \englishtitle{Text Record Segmentation and Named Attribute Values Recognition based on CNN}
  \englishAbstractTitle{Text Record Segmentation and Named Attribute Values Recognition}
  \englishfancytitle{Text Record Segmentation and Named Attribute Values Recognition}
