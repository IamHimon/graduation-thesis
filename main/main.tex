...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  % 中文封面内容
  \title{基于CNN的文本记录分割与命名属性值识别技术的研究与实现}
  \author{胡猛}
  \advisor{李直旭}
  \degree{硕~士~}
  \major{计算机科学与技术}
  ...
  % 英文封面内容
  \englishtitle{CNN-based Text Record Segmentation and Named Attribute Values Recognition}
  \englishAbstractTitle{CNN-based Text Record Segmentation and Named Attribute Values Recognition}
  \englishfancytitle{CNN-based Text Record Segmentation and Named Attribute Values Recognition}
  \englishauthor{Meng Hu}
  \englishadvisor{Zhixu Li}

  % 封面
  \includepdf{cover_hm.pdf}
  \cleardoublepage
